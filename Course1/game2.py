...
def runGame():
    ...
    startx = random.randint(5, Cell_W - 4)
    starty = random.randint(5, Cell_H - 4)
...
def getRandomLocation():
    return {'x': random.randint(0, Cell_W - 4), 'y': random.randint(0, Cell_H - 4)}
...
def showGameOverScreen():
    ...
    gameRect.midtop = (Window_Width / 5, 10)
    overRect.midtop = (Window_Width / 5, gameRect.height + 10 + 25)
...
def drawWorm(wormCoords):
    for coord in wormCoords:
        ...
        wormInnerSegmentRect = pygame.Rect(
            x + 3, y + 3, Cell_Size - 5, Cell_Size - 5)
